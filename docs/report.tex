...
\screenshot{screenshots/visualvm-mbeans-chart-points.png}{График изменения показаний PointsStatistics в VisualVM}
\screenshot{screenshots/visualvm-mbeans-chart-area.png}{График изменения показаний Area в VisualVM}
...
Наиболее активным потоком во время обработки запросов является
\begin{lstlisting}
pool-12-thread-18
\end{lstlisting}
